...
val plStrings = AppStrings().apply {
    ...
    vdbHint = "Dotknij \u201eUżyj\u201d przy własnej bazie danych, aby ustawić ją jako aktywne źródło wersetów — lub wybierz ją później w Ustawienia → Język wersetów."
    vdbUse = "Użyj"
    vdbUsed = "Aktywowano"
    vdbDeleteTitle = "Usuń"
...
val plLocalizedLangNames: Map<String, String> = mapOf(
    "EN" to "Angielski",
    "SK" to "Słowacki",
    "CZ" to "Czeski",
    "ES" to "Hiszpański",
