...
val czStrings = AppStrings().apply {
    ...
    vdbHint = "Klepněte na \u201ePoužít\u201c u vlastní databáze a nastavte ji jako aktivní zdroj veršů — nebo ji vyberte později v Nastavení → Jazyk veršů."
    vdbUse = "Použít"
    vdbUsed = "Aktivováno"
...
val czLocalizedLangNames: Map<String, String> = mapOf(
    "EN" to "Angličtina",
    "SK" to "Slovenština",
    "CZ" to "Čeština",
    "ES" to "Španělština",
