...
val frStrings = AppStrings().apply {
    ...
    vdbHint = "Touche \u00ab Utiliser \u00bb sur une base de données personnalisée pour en faire ta source de versets active — ou choisis-la plus tard dans Paramètres → Langue des versets."
    vdbUse = "Utiliser"
    vdbUsed = "Activée"
    ...
    addedOn = "Ajouté le %s"
    favoritesSubtitle = "Touchez un verset pour en faire votre fond d'écran"
    favCardStyleLabel = "Style de carte favoris"
    favCardStyleQuote = "Détaillé"
    favCardStyleCompact = "Compact"
    favCardStyleHero = "Citation"
    favCardStyleQuoteDesc = "Verset avec barre d'actions"
...
val frLocalizedLangNames: Map<String, String> = mapOf(
    "EN" to "Anglais",
    "SK" to "Slovaque",
    "CZ" to "Tchèque",
    "ES" to "Espagnol",
