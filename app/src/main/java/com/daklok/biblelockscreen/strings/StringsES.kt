...
val esStrings = AppStrings().apply {
    ...
    vdbHint = "Toca \u00abUsar\u00bb en una base de datos personalizada para convertirla en tu fuente de versículos activa — o selecciónala más tarde en Ajustes → Idioma de versículos."
    vdbUse = "Usar"
    vdbUsed = "Activada"
    ...
    vdbSourceFavorites = "Favoritos"
    vdbFavoritesCycling = "Alternando entre %d versículos favoritos"
    vdbFavoritesEmptyCta = "Añade primero algunos favoritos"
    ...
    shareActionDesc = "Enviar la imagen mediante otras apps"
    saveToGalleryAction = "Guardar en galería"
    saveToGalleryActionDesc = "Guardar la imagen en el dispositivo"
...
val esLocalizedLangNames: Map<String, String> = mapOf(
    "EN" to "Inglés",
    "SK" to "Eslovaco",
    "CZ" to "Checo",
    "ES" to "Español",
