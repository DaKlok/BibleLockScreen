...
val huStrings = AppStrings().apply {
    ...
    vdbHint = "Koppints a \u201eHasznál\u201d gombra egy egyéni adatbázisnál, hogy aktív versforrássá váljon — vagy válaszd ki később a Beállítások → Igevers nyelve menüpontban."
    vdbUse = "Használ"
    vdbUsed = "Aktiválva"
    ...
    shareActionDesc = "Kép küldése más alkalmazásokon keresztül"
    saveToGalleryAction = "Mentés a galériába"
    saveToGalleryActionDesc = "Kép mentése az eszközre"
...
val huLocalizedLangNames: Map<String, String> = mapOf(
    "EN" to "Angol",
    "SK" to "Szlovák",
    "CZ" to "Cseh",
    "ES" to "Spanyol",
